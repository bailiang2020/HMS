...
COORDS_FILE="results/DGM4/attn_analysis/multi/Qwen3_VL_2B/lora/mix_0.0025/0-256/plots/ALL/top200_heatmap_norm_share_text_coords.txt"
TEST_DATA_PATH_OVERRIDE="data/processed/DGM4/raw/test_subset_5000.pkl"
MASK_COUNTS=(10 20 30 40 50 75 100)
LABEL="mix_0.0025_text"
RUN_NAME="mix_0.0025_text_mask"
CUDA_DEVICES="1"
...
# bash scripts/utils/run_mask_sweep_mix_0.0025_text.sh