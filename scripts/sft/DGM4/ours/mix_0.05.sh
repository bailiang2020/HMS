...
EXP_NAME="main_mix_ratio_${UNIMODAL_RATIO}/hms_${PURIFICATION_THRESHOLD}_ukr_${PURIFICATION_PROTECT_SCALE}"
#EXP_NAME="main_mix_ratio_0.05/hms_0.2_ukr_0.6"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port 29301 --module "${TRAIN_MODULE}" \
