...
EXP_NAME="ablation_hms_mix_ratio_0.01/th_0.1"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port 29301 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/DGM4/ablation/hms/th_0.1/mix_0.01.sh