...
EXP_NAME="ablation_hms_mix_ratio_0.05/th_0.2"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=7 torchrun --nproc_per_node=1 --master_port 29301 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/DGM4/ablation/hms/th_0.2/mix_0.05.sh