...
EXP_NAME="ablation_ukr_mix_ratio_0.05/th_0.9"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=2 torchrun --nproc_per_node=1 --master_port 29203 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/DGM4/ablation/ukr/th_0.9/mix_0.05.sh