...
EXP_NAME="ablation_ukr_mix_ratio_0.0025/th_0.5"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port 29205 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/DGM4/ablation/ukr/th_0.5/mix_0.0025.sh