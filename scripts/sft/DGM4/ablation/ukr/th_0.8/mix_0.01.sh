...
EXP_NAME="ablation_ukr_mix_ratio_0.01/th_0.8"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port 29304 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/DGM4/ablation/ukr/th_0.8/mix_0.01.sh