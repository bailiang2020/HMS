...
PURIFICATION_PROTECT_SCALE=0.7
EXP_NAME="main_mix/hms_${PURIFICATION_THRESHOLD}_ukr_${PURIFICATION_PROTECT_SCALE}"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port 29401 --module "${TRAIN_MODULE}" \
