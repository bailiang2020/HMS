...
EXP_NAME="ablation_hms_mix/th_0.5"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port 29308 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/hms/th_0.5/mix.sh