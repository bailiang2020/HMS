...
# 数据集: washington_post
# 训练方法: mix (混合训练)
PURIFICATION_THRESHOLD=0.9
EXP_NAME="ablation_hms_mix/th_0.9"
...
# 自动构建路径和模型名称
OUTPUT_PATH="results/weibo/ours/sdpa/qwen3_vl_2B/lora/${EXP_NAME}/0-256"
MODEL_TYPE="Qwen3_VL_Custom_ablation_hms"
HEAD_ROLES_FILE="results/weibo/probe/sdpa/qwen3_vl_2B/0-256/head_roles_top50_20260330_000624.json"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=2 torchrun --nproc_per_node=1 --master_port 29301 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/hms/th_0.9/mix.sh