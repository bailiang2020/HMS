...
# 数据集: washington_post
# 训练方法: mix (混合训练)
PURIFICATION_THRESHOLD=0.4
EXP_NAME="ablation_hms_mix/th_0.4"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=3 torchrun --nproc_per_node=1 --master_port 29301 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/hms/th_0.4/mix.sh