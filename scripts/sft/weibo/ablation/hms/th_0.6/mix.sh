...
# 数据集: washington_post
# 训练方法: mix (混合训练)
PURIFICATION_THRESHOLD=0.6
EXP_NAME="ablation_hms_mix/th_0.6"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=1 torchrun --nproc_per_node=1 --master_port 29501 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/hms/th_0.6/mix.sh