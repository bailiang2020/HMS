...
# 数据集: washington_post
PURIFICATION_PROTECT_SCALE=0.5
EXP_NAME="ablation_ukr_mix/th_0.5"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=3 torchrun --nproc_per_node=1 --master_port 29201 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/ukr/th_0.5/mix.sh