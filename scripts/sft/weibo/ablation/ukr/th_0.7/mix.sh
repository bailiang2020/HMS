...
EXP_NAME="ablation_ukr_mix/th_0.7"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=2 torchrun --nproc_per_node=1 --master_port 29201 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/ukr/th_0.7/mix.sh