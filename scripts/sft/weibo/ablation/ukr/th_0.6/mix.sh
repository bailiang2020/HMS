...
# 数据集: washington_post
PURIFICATION_PROTECT_SCALE=0.6
EXP_NAME="ablation_ukr_mix/th_0.6"
...
# 调用训练模块
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port 29202 --module "${TRAIN_MODULE}" \
...
# bash scripts/sft/weibo/ablation/ukr/th_0.6/mix.sh